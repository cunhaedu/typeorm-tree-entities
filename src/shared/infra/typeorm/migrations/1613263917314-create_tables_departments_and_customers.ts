...
export default class createTablesDepartmentsAndCustomers1613263917314 implements MigrationInterface {
  name = 'createTablesDepartmentsAndCustomers1613263917314'
